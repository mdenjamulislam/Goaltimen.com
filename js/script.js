$(document).ready(function(){
	$("#scroll_up").click(function(){
		$("#page-title").animate({scrollTop:0},100);
	});
});
...
/* this ia faq panel */
$(document).ready(function(){
	$("#panel-heading_1").click(function(){
		$("#panel-body_1").show(1000);
	});
	$("#panel-heading_1").click(function(){
		$("#panel-body_2").hide();
	});
	...
	$("#panel-heading_2").click(function(){
		$("#panel-body_2").show(1000);
	});
	$("#panel-heading_2").click(function(){
		$("#panel-body_1").hide();
	});
	...
	$("#panel-heading_3").click(function(){
		$("#panel-body_3").show(1000);
	});
	$("#panel-heading_3").click(function(){
		$("#panel-body_1").hide();
	});
	...
	$("#panel-heading_4").click(function(){
		$("#panel-body_4").show(1000);
	});
	$("#panel-heading_4").click(function(){
		$("#panel-body_1").hide();
	});
...
/* =================== timeline javascript end ====================*/


/* ================ distribution chart javascript =================*/
//doughnut
